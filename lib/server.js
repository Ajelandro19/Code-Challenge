...
app.get("/havecertificate/emails", (request, response) => {
    const studentscertifiedemails = StudentController.getemailsCertified();
    response.json(studentscertifiedemails);
});
